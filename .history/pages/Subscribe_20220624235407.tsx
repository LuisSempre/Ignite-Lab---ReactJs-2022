        ...
        <div className='flex flex-col items-center min-h-screen'>
            <div className="flex items-center justify-between w-full max-w-6xl mx-auto mt-20">
                ...
                <div className="p-8 border border-white rounded">
                    <strong className="block mb-6 text-2xl">Inscreve-se gratuitamente</strong>
                    <form action="" className="flex flex-col w-full gap-2">
                        ...
                        <input className="px-6 bg-black border border-white h-14" type="text" placeholder="Digite seu e-mail"/>
                    </form>
                </div>
            </div>
        </div>
